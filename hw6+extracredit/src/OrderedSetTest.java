...
public class OrderedSetTest {
    ...
    SplayTree<Integer> set;
    SplayTree<Integer> set2;
   
   
    @Before
    public void setupSet() {
        set = new SplayTree<Integer>();
        set2 = new SplayTree<Integer>();
    }
    @Test
    ...
    public void testUnion() {
        ...
        System.out.println("ha2hah");
        System.out.println(set.union(set2).toString());
        System.out.println("hah3ah");
